...
class ReactSpeedometerManual extends PureComponent {
...
ReactSpeedometerManual.propTypes = {
...
ReactSpeedometerManual.defaultProps = DEFAULT_PROPS

export default ReactSpeedometerManual
